...
class IconConstants{
  ...
  static String logoRow = "assets/images/logoRow.png";
  static String doc = "assets/images/doc.png";
  static String day = "assets/images/day.png";
  ...
  static String thing = "assets/images/thing.png";
...
class ColorConstants {
  static Color mainAppColor = const Color(0xFFFFB63c);
  static Color secondAppColor = const Color(0xff152044);
